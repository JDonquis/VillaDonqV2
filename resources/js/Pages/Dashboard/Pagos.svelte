    ...
    <form id="a-form" on:submit={handleSubmit} action="" class="w-[600px]">
        ...
        >
            ...
            <Input
                ...
                required={true}
                label={"Moneda"}
                bind:value={$formCreate.currency}
                error={$formCreate.errors?.currency}
            >
    ...
    <form id="a-form" on:submit={handleSubmit} action="" class="w-[600px]">
        ...
        >
            ...
            >
                ...
                <option value="Masculino">Bolivares</option>
                <option value="Femenino">Dolares</option>
            </Input>
            <Input
                type="number"
                label={"Monto"}
